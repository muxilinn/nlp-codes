...
这是[深圳技术大学2025秋季微专业课](https://hqyang.github.io/nlp-codes/)使用的Jupyter Notebook.下面尝试构建基一个基于规则的情感分类器。它将接收文本“X”并返回一个“标签”，如果文本的情感是积极的，则为“1”，如果文本的情感是消极的，则为“-1”，如果文本的情感是中性的，则为“0”。通过运行这个notebook 你可以在[Stanford Sentiment Treebank](http://nlp.stanford.edu/sentiment/index.html)上测试分类器的准确性。
